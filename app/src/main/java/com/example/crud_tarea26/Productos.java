...
public class Productos extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnListado.setOnClickListener(v -> {
            ...
            // Pasar datos para mantener sesión
        ...
        call.enqueue(new Callback<Void>() {
            ...
            public void onResponse(Call<Void> call, Response<Void> response) {
                if (response.isSuccessful()) {
                    Toast.makeText(Productos.this, "Producto guardado exitosamente", Toast.LENGTH_SHORT).show();
                    limpiarCampos();
                } else {
            ...
            public void onFailure(Call<Void> call, Throwable t) {
                Toast.makeText(Productos.this, "Fallo la conexión: " + t.getMessage(), Toast.LENGTH_LONG).show();
            }
        });
    }
